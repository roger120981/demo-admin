...
interface AgenciesFacetedFilterProps<TData, TValue> {
  column?: Column<TData, TValue>;
  title?: string;
  options: { label: string; value: string }[];
}

export function AgenciesFacetedFilter<TData, TValue>({
  column,
  title,
  options,
}: AgenciesFacetedFilterProps<TData, TValue>) {
  const { filters, setFilters } = useAgenciesStore();
